...
# set_page_config and the shared responsive CSS live in draftaid.py (the
# navigation entry point); this file runs as the Draft Room page.

AUTOSAVE = Path(__file__).resolve().parent.parent / "draft_autosave.json"
